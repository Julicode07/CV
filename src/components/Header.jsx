...
export default function Header() {
    ...
    return (
        <div className="relative flex flex-col gap-1 md:gap-2 bg-gradient-to-r from-gray-800 to-gray-900 p-6 md:p-12 text-white overflow-hidden">
                ...
                >
                    ...
                    <label htmlFor="hs-basic-usage" className="relative inline-block w-8 md:w-11 h-4 md:h-6 cursor-pointer">
                        <input
                            ...
                            aria-label="Cambiar idioma" // Agrega una descripción para lectores de pantalla
                        />
